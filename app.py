...
app.config['MYSQL_PASSWORD'] = 'Good@123'
...
def articles2():
    ...
    # Fetches in the form of a dictionary
    ...
    if result > 0:
        ...
        return render_template('articles2.html', msg = msg)
...
# Dashboard
# Decoraters - will give access control
@app.route('/dashboard')
@is_logged_in
def dashboard():
    # Create cursor
